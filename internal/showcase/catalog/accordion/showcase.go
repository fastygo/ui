...
func previewDefault(ctx context.Context, w io.Writer) error {
	return wfStack(ctx, w, templ.Attributes{"data-ui8kit": "accordion"}, func(ctx context.Context, w io.Writer) error {
		if err := showcaseutil.Button(ui.ButtonProps{Attrs: templ.Attributes{"data-ui8kit-trigger": "item-1", "aria-expanded": "false"}}, "Section 1").Render(ctx, w); err != nil {
			return err
		}
